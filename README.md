...
- [ ] 02.03 ~ 02.07 메인,서브페이지 디자인 폭은 640모바일고정으로 작성하고 텍스트는 본인이 생각하신것을 넣되 폰트는 웹폰트로 작성 부탁드립니다. -Sohyun
